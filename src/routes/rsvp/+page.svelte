...
<div class="flex flex-col justify-center p-4">
    ...
    <div class="flex flex-wrap text-center justify-center items-center text-2xl">
        <p>
...
<div class="flex flex-col justify-center items-center pb-12">
    <div class="card box-content max-w-sm md:max-w-2xl shadow-md rounded-3xl overflow-hidden variant-glass-primary dark:variant-ghost-primary-400">
            ...
            <form method="POST" use:enhance={onFormSubmit} class="flex flex-col items-center space-y-4 py-4">
                ...
                <label class="label text-secondary-600"> 
                    <input class="input box-border h-[42px] w-[262.58px] text-black font-medium dark:bg-tertiary-300 placeholder:text-primary-800" name="name" type="text" placeholder=" Name " required>
                </label>        
                <label class="label text-secondary-600">
                    <input class="input box-border h-[42px] w-[262.58px] text-black font-medium dark:bg-tertiary-300 placeholder:text-primary-800" name="email" type="text" placeholder=" Email Address" required>
                </label>
                {#if attendance == true}
                    <label class="label text-secondary-600">
                        <input class="input box-border h-[42px] w-[262.58px] text-black font-medium dark:bg-tertiary-300 placeholder:text-primary-800" name="guests" type="text" placeholder=" Number of Guests ">
                    </label>
                {/if}
