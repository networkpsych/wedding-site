...
<div class="card flex items-center justify-center text-4xl text-justify size-full rounded-lg variant-glass-primary">
    <div class="grid gap-y-4 grid-cols-2 grid-row-4">
        {#each dates as {id, time}}
                {#if time > 1}
                    <span class="italic text-left">{time}</span><span class="align-baseline text-left">{id}s</span>
                {:else if time == 1}
                    <span class="italic text-left">{time}</span><span class="align-baseline text-left">{id}</span>
