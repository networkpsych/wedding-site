...
<div class="flex flex-col items-center content-center mx-auto text-nowrap">
	<div class="drop-shadow-xl text-secondary-500 lg:text-surface-500 font-nfRegular text-4xl lg:text-6xl">Brayden & Madeline</div>
	<div class="drop-shadow-xl text-secondary-500 lg:text-surface-500 font-nfPrintBold text-4xl lg:text-6xl ">
		5/31/2025
	</div>
